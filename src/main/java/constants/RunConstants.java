...
public class RunConstants {
	...
	public static final boolean
		...
		RUNNING_EVERYTHING = true && RUNNING_DRIVE && RUNNING_PNEUMATICS && RUNNING_LEADSCREW && RUNNING_BALL && RUNNING_HATCH && SECONDARY_JOYSTICK && RUNNING_CC_CLIMBER; // && RUNNING_CLIMBER;
}